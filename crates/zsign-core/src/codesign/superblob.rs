...
//!
//! ```
//! use zsign_core::codesign::{SuperBlobBuilder, CodeDirectoryBuilder};
//!
...
///
/// ```
/// use zsign_core::codesign::BlobEntry;
/// use zsign_core::codesign::constants::CSSLOT_CODEDIRECTORY;
///
...
///
/// ```
/// use zsign_core::codesign::{build_superblob, BlobEntry};
...
///
/// ```
/// use zsign_core::codesign::build_entitlements_blob;
///
...
///
/// ```
/// use zsign_core::codesign::build_der_entitlements_blob;
///
...
///
/// ```
/// use zsign_core::codesign::build_requirements_blob;
///
...
///
/// ```
/// use zsign_core::codesign::build_signature_blob;
///
...
///
/// ```
/// use zsign_core::codesign::superblob::build_adhoc_signature_blob;
///
